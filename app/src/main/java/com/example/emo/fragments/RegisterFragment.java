...
public class RegisterFragment extends Fragment {
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    DatabaseReference usersRef = com.example.emo.firebase.FirebaseDataManager.getDatabaseReference().child("Users");
    ...
    private void setupPasswordToggle() {
        ...
        confirmPasswordEt.setOnTouchListener((v, event) -> {
            ...
            if (event.getAction() == android.view.MotionEvent.ACTION_UP) {
                if (event.getRawX() >= (confirmPasswordEt.getRight() - confirmPasswordEt.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width() - confirmPasswordEt.getPaddingRight())) {
                    // Переключение видимости пароля
                    if (confirmPasswordEt.getInputType() == (android.text.InputType.TYPE_CLASS_TEXT | android.text.InputType.TYPE_TEXT_VARIATION_PASSWORD)) {
                        // Показать пароль
                        confirmPasswordEt.setInputType(android.text.InputType.TYPE_CLASS_TEXT | android.text.InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD);
                    } else {
                        // Скрыть пароль
                        confirmPasswordEt.setInputType(android.text.InputType.TYPE_CLASS_TEXT | android.text.InputType.TYPE_TEXT_VARIATION_PASSWORD);
                    }
                    // Сохраняем позицию курсора
