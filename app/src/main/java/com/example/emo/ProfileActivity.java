...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // FirebaseDataManager.testFirebaseConfiguration(); // Удалено, так как FirebaseDataManager инициализируется в SplashActivity
    ...
    private void loadUserData() {
        ...
        try {
            ...
            // FirebaseDataManager.readUsernameDirectly(userId, new FirebaseDataManager.OnUsernameLoadedListener() { // Удалено, так как FirebaseDataManager инициализируется в SplashActivity
            //     @Override
            ...
            //     }
            // });
            loadUsernameWithFallback(); // Вызываем метод загрузки имени пользователя с запасным вариантом
    ...
    private void loadUsernameWithFallback() {
        ...
        // FirebaseDataManager.getUserName() // Удалено, так как FirebaseDataManager инициализируется в SplashActivity
        //         .thenAccept(username -> {
        //             runOnUiThread(() -> {
        //                 if (usernameTv != null) usernameTv.setText(username);
        ...
        //             return null;
        //         });
        tryLoadUsernameDirectly(); // Вызываем метод прямого чтения при неудаче запасного метода
    }
