                ...
                .addOnSuccessListener(aVoid -> {
                    userRef.child("email").setValue(newEmail)
                            ...
                            .addOnFailureListener(e -> {
                                ...
                                Toast.makeText(this, "Ошибка сохранения email в базе данных: " + e.getMessage(), Toast.LENGTH_LONG).show();
                                showProgress(false);
                            });
                })
                .addOnFailureListener(e -> {
                    ...
                    if (e instanceof FirebaseAuthRecentLoginRequiredException) {
                        errorMessage = "Эта операция требует недавней аутентификации. Пожалуйста, выйдите из аккаунта и войдите снова, затем попробуйте изменить Email.";
                    } else {
                        errorMessage = "Ошибка обновления email: " + e.getMessage();
                    }
                    Log.e(TAG, "Ошибка обновления email: " + errorMessage);
